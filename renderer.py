...
class Renderer:
    ...
    def __init__(self, maxDataStorage):
        pygame.display.init()
        ...
        self.my_font = pygame.font.SysFont('Comic Sans MS', 30, bold=True)
        self.max_data_storage = maxDataStorage
    ...
    def render(self, com_orbit_points, obs_orbit_points, com_current_orbit_points, obs_current_orbit_points, comms,
        ...
        self.show_data_percentage(currentData)
        # self.draw_attractor()
    ...
    def show_data_percentage(self, currentData):
        data_perc = ( (self.max_data_storage - currentData) / self.max_data_storage) * 100
        text_surface = self.my_font.render(f'Data send: {data_perc}', False, self.WHITE)
